...
namespace FPS_n2 {
	namespace Sceneclass {
		...
		public://ゲッター
			...
			const auto GetAmmoNum(void) const noexcept { return GetAmmoNumHaveMagControl() + (GetInChamber() ? 1 : 0); }

		public:
			void CockByMag() noexcept { this->m_ChamberAmmoData = GetAmmoSpecMagTop(); }//マガジンの一番上の弾データをチャンバーイン
